...
(function() {
  ...
  var prompt = "> ",
    ...
    commands = {
      "dso": function() {
        ...
        setTimeout(function() {
          animatedLog("> En, heeft het geholpen? ", "#00FF00", "animatedIntroMessage3", function() {
            animatedLog("> Oh nou, misschien ben je gewoon te lelijk.", "#00FF00", "animatedIntroMessage4", function() {
              animatedLog("> Als je denkt dat het een probleem is, probeer eens contact op te nemen met Amatsukami.", "#00FF00", "animatedIntroMessage5", function() {
                animatedLog("> Misschien maken ze een uitzondering voor lelijke mensen zoals jij.", "#00FF00", "animatedIntroMessage6", function() {
				  setTimeout(function(){location.reload()}, 3000);
                }, 800, 1000);
              }, 1400, 1000);
            }, 800, 1000);
          }, 500), 1000;
        }, ((logs.length + 1) * 1000) + 1000);
      }
    };

  function newline() {
    var node = document.createElement("p");
    node.setAttribute("tag", "input");
  ...
  function init() {
    animatedLog("> Error 403: Helaas, jouw IP staat niet in het grote boek van de DSO.", "#00FF00", "animatedIntroMessage1", function() {
      window.setTimeout(function() {
        animatedLog("> Probeer het commando 'dso' misschien helpt het", "#00FF00", "animatedIntroMessage2", function() {
          newline();
        });
      }, 500);
    });
